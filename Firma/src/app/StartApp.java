...
public class StartApp {
	...
	public void init() {
		...
		StavkaFakture s3 = new StavkaFakture(new BigDecimal("3"), "Stavka3", new BigDecimal("14"), "jedinicaMere",
				new BigDecimal("107.24"), new BigDecimal("123"), new BigDecimal("8.2"), new BigDecimal("10.086"),
				new BigDecimal("112.914"), new BigDecimal("18.2"));
		...
		StavkaFakture s5 = new StavkaFakture(new BigDecimal("5"), "Stavka5", new BigDecimal("10"), "jedinicaMere",
				new BigDecimal("1421"), new BigDecimal("1487.5"), new BigDecimal("15.2"), new BigDecimal("226.1"),
				new BigDecimal("1261.4"), new BigDecimal("109.54"));
		...
		bankaC.dodajRacun("f", "111123456789987621");
		Banka bankaD = new Banka("Generali", "456", "345");
		bankaD.dodajRacun("firmaB", "22298765432112307");

		Firme firme = new Firme();
		Firma firmaA = new Firma("f", "f", "8180", "Firma A", "Novosadskog Sajma 10", "11111111111", bankaC,
				firmaAstavke);
		Firma firmaB = new Firma("firmaB", "firmaB", "8280", "Firma B", "Bulevar Oslobodjenja 55", "22222222222",
				bankaD, firmaBstavke);
