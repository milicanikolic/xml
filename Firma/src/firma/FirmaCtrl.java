...
public class FirmaCtrl {
 ...
 public Faktura kreirajFakturu(@PathParam("kupacUlogovan") String kupacUlogovan,
  ...
  System.out.println("sada datum " + now.getYear() + "/" + now.getMonth()+"/"+now.getDay()+" "+now.getHour()+":"+now.getMinute()+":"+now.getSecond() );
  ...
  try {
   ...
   marshallerFirma.marshal(firmeBaza, new File(System.getProperty(StartApp.getJbossDir()), StartApp.getFileNameFirma()));
